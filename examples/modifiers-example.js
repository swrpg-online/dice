...
console.log(`   Result: ${result1.summary.successes} successes, ${result1.summary.advantages} advantages\n`);
...
console.log(`   Result: ${result2.summary.successes} successes, ${result2.summary.advantages} advantages\n`);
...
console.log(`   Result: ${result3.summary.successes} successes, ${result3.summary.threats} threats\n`);
...
console.log(`   Result: ${result5.summary.successes} successes, ${result5.summary.advantages} advantages\n`);
...
console.log(`   Result: ${result6.summary.successes} successes, ${result6.summary.advantages} advantages\n`);
